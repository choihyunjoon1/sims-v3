 ...
 */
package co.spoonradio.sims.repository.mysql
...
open class DefaultSchema : SchemaImpl("", DefaultCatalog.DEFAULT_CATALOG) {
     ...
     */
    val ADMIN_USER get() = AdminUser.ADMIN_USER

    /**
     * The table <code>allow_equi</code>.
     */
    val ALLOW_EQUI get() = AllowEqui.ALLOW_EQUI

    /**
     * The table <code>audit_log</code>.
     */
    val AUDIT_LOG get() = AuditLog.AUDIT_LOG

    /**
     * The table <code>auth_group</code>.
     */
    val AUTH_GROUP get() = AuthGroup.AUTH_GROUP

    /**
     * The table <code>auth_group_permissions</code>.
     */
    val AUTH_GROUP_PERMISSIONS get() = AuthGroupPermissions.AUTH_GROUP_PERMISSIONS

    /**
     * The table <code>auth_permission</code>.
     */
    val AUTH_PERMISSION get() = AuthPermission.AUTH_PERMISSION

    /**
     * The table <code>authtoken_token</code>.
     */
    val AUTHTOKEN_TOKEN get() = AuthtokenToken.AUTHTOKEN_TOKEN

    /**
     * The table <code>batch_log</code>.
     */
    val BATCH_LOG get() = BatchLog.BATCH_LOG

    /**
     * The table <code>batch_log_deail</code>.
     */
    val BATCH_LOG_DEAIL get() = BatchLogDeail.BATCH_LOG_DEAIL

    /**
     * The table <code>batch_manage</code>.
     */
    val BATCH_MANAGE get() = BatchManage.BATCH_MANAGE

    /**
     * The table <code>com_code</code>.
     */
    val COM_CODE get() = ComCode.COM_CODE

    /**
     * The table <code>django_admin_log</code>.
     */
    val DJANGO_ADMIN_LOG get() = DjangoAdminLog.DJANGO_ADMIN_LOG

    /**
     * The table <code>django_content_type</code>.
     */
    val DJANGO_CONTENT_TYPE get() = DjangoContentType.DJANGO_CONTENT_TYPE

    /**
     * The table <code>django_migrations</code>.
     */
    val DJANGO_MIGRATIONS get() = DjangoMigrations.DJANGO_MIGRATIONS

    /**
     * The table <code>django_session</code>.
     */
    val DJANGO_SESSION get() = DjangoSession.DJANGO_SESSION

    /**
     * The table <code>external_link_log</code>.
     */
    val EXTERNAL_LINK_LOG get() = ExternalLinkLog.EXTERNAL_LINK_LOG

    /**
     * The table <code>grade_menu_auth_list</code>.
     */
    val GRADE_MENU_AUTH_LIST get() = GradeMenuAuthList.GRADE_MENU_AUTH_LIST

    /**
     * The table <code>grant_log</code>.
     */
    val GRANT_LOG get() = GrantLog.GRANT_LOG
     ...
     */
    val NOTICE get() = Notice.NOTICE

    /**
     * The table <code>notice_check</code>.
     */
    val NOTICE_CHECK get() = NoticeCheck.NOTICE_CHECK

    /**
     * The table <code>otp_totp_totpdevice</code>.
     */
    val OTP_TOTP_TOTPDEVICE get() = OtpTotpTotpdevice.OTP_TOTP_TOTPDEVICE

    /**
     * The table <code>spc_auth_req</code>.
     */
    val SPC_AUTH_REQ get() = SpcAuthReq.SPC_AUTH_REQ

    /**
     * The table <code>spc_auth_req_info</code>.
     */
    val SPC_AUTH_REQ_INFO get() = SpcAuthReqInfo.SPC_AUTH_REQ_INFO

    /**
     * The table <code>spoon_reward</code>.
     */
    val SPOON_REWARD get() = SpoonReward.SPOON_REWARD

    /**
     * The table <code>spoon_reward_user</code>.
     */
    val SPOON_REWARD_USER get() = SpoonRewardUser.SPOON_REWARD_USER

    /**
     * The table <code>sub_menu</code>.
     */
    val SUB_MENU get() = SubMenu.SUB_MENU

    /**
     * The table <code>tbExchangeActionHistory</code>.
     */
    val TBEXCHANGEACTIONHISTORY get() = Tbexchangeactionhistory.TBEXCHANGEACTIONHISTORY

    /**
     * The table <code>tbSpoonValidSyncHistory</code>.
     */
    val TBSPOONVALIDSYNCHISTORY get() = Tbspoonvalidsynchistory.TBSPOONVALIDSYNCHISTORY

    /**
     * The table <code>team_menu_auth_list</code>.
     */
    val TEAM_MENU_AUTH_LIST get() = TeamMenuAuthList.TEAM_MENU_AUTH_LIST

    /**
     * The table <code>terms</code>.
     */
    val TERMS get() = Terms.TERMS

    /**
     * The table <code>terms_check</code>.
     */
    val TERMS_CHECK get() = TermsCheck.TERMS_CHECK

    /**
     * The table <code>user_menu_auth</code>.
     */
    val USER_MENU_AUTH get() = UserMenuAuth.USER_MENU_AUTH

    /**
     * The table <code>users_deactive</code>.
     */
    val USERS_DEACTIVE get() = UsersDeactive.USERS_DEACTIVE

    /**
     * The table <code>voc_attachment</code>.
     */
    val VOC_ATTACHMENT get() = VocAttachment.VOC_ATTACHMENT

    /**
     * The table <code>voc_banshistory</code>.
     */
    val VOC_BANSHISTORY get() = VocBanshistory.VOC_BANSHISTORY

    /**
     * The table <code>voc_hist</code>.
     */
    val VOC_HIST get() = VocHist.VOC_HIST

    /**
     * The table <code>voc_reply</code>.
     */
    val VOC_REPLY get() = VocReply.VOC_REPLY

    override fun getCatalog(): Catalog = DefaultCatalog.DEFAULT_CATALOG

    override fun getTables(): List<Table<*>> = listOf(
        AdminUser.ADMIN_USER,
        AllowEqui.ALLOW_EQUI,
        AuditLog.AUDIT_LOG,
        ...
        BatchLog.BATCH_LOG,
        BatchLogDeail.BATCH_LOG_DEAIL,
        BatchManage.BATCH_MANAGE,
        ComCode.COM_CODE,
        ...
        ExternalLinkLog.EXTERNAL_LINK_LOG,
        GradeMenuAuthList.GRADE_MENU_AUTH_LIST,
        GrantLog.GRANT_LOG,
        Menu.MENU,
        Notice.NOTICE,
        NoticeCheck.NOTICE_CHECK,
        OtpTotpTotpdevice.OTP_TOTP_TOTPDEVICE,
        SpcAuthReq.SPC_AUTH_REQ,
        SpcAuthReqInfo.SPC_AUTH_REQ_INFO,
        SpoonReward.SPOON_REWARD,
        SpoonRewardUser.SPOON_REWARD_USER,
        SubMenu.SUB_MENU,
        Tbexchangeactionhistory.TBEXCHANGEACTIONHISTORY,
        Tbspoonvalidsynchistory.TBSPOONVALIDSYNCHISTORY,
        TeamMenuAuthList.TEAM_MENU_AUTH_LIST,
        Terms.TERMS,
        TermsCheck.TERMS_CHECK,
        UserMenuAuth.USER_MENU_AUTH,
        UsersDeactive.USERS_DEACTIVE,
        VocAttachment.VOC_ATTACHMENT,
        VocBanshistory.VOC_BANSHISTORY,
        VocHist.VOC_HIST,
        VocReply.VOC_REPLY
    )
}
